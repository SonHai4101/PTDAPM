...
public class UpdateProduct extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EditText des = (EditText) findViewById(R.id.update_des);
        ...
        update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Product updateproduct = new Product(id.getText().toString(), name.getText().toString()
                        , Integer.parseInt(quantity.getText().toString()), price.getText().toString(), des.getText().toString(), product.getImage());
                if (sqlite.updateProduct(updateproduct, id.getText().toString())) {
                    Toast toast = Toast.makeText(UpdateProduct.this, "Update successfully", Toast.LENGTH_LONG);
                    toast.show();
                    Intent intent = new Intent(UpdateProduct.this, ListProduct.class);
                    startActivity(intent);
                } else {
                    Toast toast = Toast.makeText(UpdateProduct.this, "Update failed", Toast.LENGTH_LONG);
                    toast.show();
                }
            }
        });
