...
public class AddProduct extends AppCompatActivity {
    ...
    private void insertProduct() {
        add.setOnClickListener(view -> {
            ...
            EditText des = (EditText) findViewById(R.id.edit_txt_des);
            Product newproduct = new Product(id.getText().toString(),
                    name.getText().toString(), Integer.parseInt(quantity.getText().toString()),
                    price.getText().toString(), des.getText().toString(), product.getImage());
            sqlite.insertProduct(newproduct);
            if (sqlite.insertProduct(newproduct) == true) {
                Toast toast = Toast.makeText(AddProduct.this, "Add successfully", Toast.LENGTH_LONG);
                toast.show();
                Intent intent = new Intent(AddProduct.this, ListProduct.class);
                startActivity(intent);
            } else {
                Toast toast = Toast.makeText(AddProduct.this, "Add failed", Toast.LENGTH_LONG);
                toast.show();
            }
        });
    }
